...
title('Runtime with the size of the localized region','Fontsize', fontsize2)
xlabel({'$$Number\ of\ subsystems\ in$$'; '$$the\ localized\ region$$'},'Interpreter','latex','Fontsize', fontsize1)
